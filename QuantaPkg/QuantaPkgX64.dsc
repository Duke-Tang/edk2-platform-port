## @file
#  Quanta Platform DSC — forked from OvmfPkgX64
#  Adds QuantaPkg custom PCDs and QuantaPlatformDxe (SMBIOS Type 128).
#
#  SPDX-License-Identifier: BSD-2-Clause-Patent
##

[Defines]
  PLATFORM_NAME                  = Quanta
  PLATFORM_GUID                  = D1E2F3A4-B5C6-7890-ABCD-EF0123456789
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/QuantaX64
  SUPPORTED_ARCHITECTURES        = X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = QuantaPkg/QuantaPkgX64.fdf
...
[PcdsFixedAtBuild]
  # Quanta custom PCDs
  gQuantaPkgTokenSpaceGuid.PcdQuantaBoardId|0x0001
  gQuantaPkgTokenSpaceGuid.PcdQuantaFirmwareVersionString|L"Quanta FW 1.0.0"
...
!endif
  #
  # Quanta OEM Platform Driver -- installs SMBIOS Type 128
  #
  QuantaPkg/QuantaPlatformDxe/QuantaPlatformDxe.inf
